...
import { Checkbox, useDataPageLogic } from './DataPageComponents';
        ...
        <S.ContentSection>
          ...
          <S.SearchSection>
            <S.SearchInputWrapper>
              <S.SearchInput placeholder='상호명으로 검색하세요...' />
              <S.SearchIconWrapper>
                <Search size={20} />
              </S.SearchIconWrapper>
            </S.SearchInputWrapper>
          ...
          <S.TableContainer>
              ...
              <S.CheckboxCell>
                <Checkbox
                  checked={
                    ...
                    paginatedData.every((row: TableRow) => checkedRows.includes(row.id))
                  }
            ...
            {paginatedData.map((row: TableRow) => (
              <S.TableRow key={row.id}>
                ...
                <S.TableCell width='220px'>
                  <S.CellText>{row.facilityType}</S.CellText>
                </S.TableCell>
                <S.TableCell flex>
